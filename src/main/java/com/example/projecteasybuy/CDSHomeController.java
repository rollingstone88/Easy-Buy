...
public class CDSHomeController {
    @FXML
    ...
    public void initialize() throws FileNotFoundException {
        ...
        try {
            ...
            String Query = "select * from iut_cds";
            String q1 = "select count(*) from iut_cds;";
    ...
    private VBox productView(Products product)throws FileNotFoundException {
        ...
        FileInputStream input = new FileInputStream("C:/Users/HP/projectEasyBuy/src/main/resources/com/example/projecteasybuy/cds/" + product.getImageFile());
        ...
        addButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                CDSShoppingCart shoppingCart = CDSShoppingCart.getInstance();
