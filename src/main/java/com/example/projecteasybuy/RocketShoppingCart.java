...
public class RocketShoppingCart {
    private static RocketShoppingCart INSTANCE;
    Products product;
    public static RocketShoppingCart getInstance(){
        if(INSTANCE==null){
            INSTANCE= new RocketShoppingCart();
        }
    ...
    public List<CartEntry> rocketgetEntries(){
