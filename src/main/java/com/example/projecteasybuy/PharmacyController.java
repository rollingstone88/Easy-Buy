...
public class PharmacyController {
    ...
    public void initialize() throws FileNotFoundException {
        ...
        PharmacyLabel.setStyle("-fx-font-weight: bold;-fx-font-size:25pt;-fx-text-fill: #fc0202");
        ProductsGridPane.add(PharmacyLabel, 1, 0);
    ...
    private VBox productView(Products product)throws FileNotFoundException {
        ...
        addButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                PharmacyShoppingCart shoppingCart = PharmacyShoppingCart.getInstance();
