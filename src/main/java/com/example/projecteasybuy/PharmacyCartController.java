...
public class PharmacyCartController {
    @FXML
    ...
    public void initialize() throws FileNotFoundException {
        //populate the view
        List<CartEntry> entries = PharmacyShoppingCart.getInstance().pharmacygetEntries();
        ...
        if (entries.isEmpty()) {
            ...
            HBox totalView = totalView((float) PharmacyShoppingCart.getInstance().calculateTotal());
        ...
        ptcButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                try {
                    ...
                    Order order = new Order("PHARMACY", id);
    ...
    public Products Make_Product(String name) {
        ...
        try {
            ...
            String Query = "SELECT * FROM PHARMACY WHERE NAME = '" + name + "'";
    ...
    private HBox cartEntryView(CartEntry cartEntry) throws FileNotFoundException {
        ...
        plusButton.setOnAction(e -> {
            ...
            PharmacyShoppingCart.getInstance().addProduct(product);
            quantity.setText(String.valueOf(PharmacyShoppingCart.getInstance().getQuantity(name)));
            this.totalPriceLabel.setText(String.valueOf(PharmacyShoppingCart.getInstance().calculateTotal()));
        });
        ...
        minusButton.setOnAction(e -> {
            String name = (String) ((Node) e.getSource()).getUserData();
            PharmacyShoppingCart.getInstance().removeProduct(name);
            quantity.setText(String.valueOf(PharmacyShoppingCart.getInstance().getQuantity(name)));
            this.totalPriceLabel.setText(String.valueOf(PharmacyShoppingCart.getInstance().calculateTotal()));
        });
